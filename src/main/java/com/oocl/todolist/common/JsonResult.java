...
public class JsonResult<T> {
    ...
    public static <T> JsonResult<T> http400() {
        JsonResult<T> ret = new JsonResult<>();
        ret.setCode(JsonReturnCode.ILLEGAL_ARGUMEN.getCode());
        ret.setMsg(JsonReturnCode.ILLEGAL_ARGUMEN.getDesc());
        return ret;
    }

    public static <T> JsonResult<T> http503() {
        JsonResult<T> ret = new JsonResult<>();
        ret.setCode(JsonReturnCode.SERVICE_UNAVAILABLE.getCode());
        ret.setMsg(JsonReturnCode.SERVICE_UNAVAILABLE.getDesc());
        return ret;
    }
}
